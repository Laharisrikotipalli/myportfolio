    ...
    <section id="about" className="section-pad-alt">
      <div className="container">
        ...
        <div className="about-grid">
          {/* Left – Photo */}
          <div ref={photoRef} className="reveal-left" style={{ position: 'relative' }}>
            <div style={{
              ...
              <div style={{ position: 'absolute', bottom: 22, left: 0, right: 0, textAlign: 'center', zIndex: 2 }}>
                <div style={{ fontFamily: "'Syne', sans-serif", fontWeight: 700, fontSize: '1.05rem', color: '#fff', marginBottom: 4 }}>
          ...
          {/* Right – Text */}
          <div ref={textRef} className="reveal-right" style={{ paddingTop: 10 }}>
            ...
            {/* Staggered chips via CSS */}
            <div ref={chipsRef} className="reveal-stagger" style={{ display: 'flex', flexWrap: 'wrap', gap: 8, marginBottom: '2rem' }}>
              {CHIPS.map(c => (
